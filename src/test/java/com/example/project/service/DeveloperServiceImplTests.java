...
public class DeveloperServiceImplTests {
    ...
    public void givenEmail_whenGetByEmail_thenDeveloperIsReturned() {
        //given
        String email = DataUtils.getJohnDoePersisted().getEmail();
        BDDMockito.given(developerRepository.findByEmail(anyString()))
                .willReturn(DataUtils.getJohnDoePersisted());
        //when
    ...
    @Test
    @DisplayName("Test get all active developers functionality")
    public void givenThreeDevelopers_whenGetAll_thenOnlyActiveWillBeReturned() {
        //given
    ...
    public void givenThreeDevelopersAndTwoActive_whenGetAllActiveBySpecialty_thenDevelopersBeReturned() {
        //given
        DeveloperEntity developer1 = DataUtils.getJohnDoePersisted();
        DeveloperEntity developer2 = DataUtils.getMikeSmithPersisted();
        ...
        BDDMockito.given(developerRepository.findAllActiveBySpecialty(anyString()))
                .willReturn(developers);
        //when
        List<DeveloperEntity> obtainedDevelopers = serviceUnderTest.getAllActiveDevelopers("Java");
        //then
        assertThat(CollectionUtils.isEmpty(obtainedDevelopers)).isFalse();
        assertThat(obtainedDevelopers.size()).isEqualTo(2);
    }
